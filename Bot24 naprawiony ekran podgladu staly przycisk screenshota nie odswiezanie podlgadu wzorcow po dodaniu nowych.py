...
class AutoClicker:
    def __init__(self, root):
        ...
        # Zamiast jednego wzorca – lista wzorców
        self.templates = []
        ...
        # Dodanie etykiety dla nowego zrzutu testowego – klawisz F10
        ttk.Label(frame_keys, text="Nowy Screenshot: F10", style="TLabel").pack(side=tk.LEFT, padx=5)
    ...
    def lock_interface(self):
        widgets = (self.key_entries + self.interval_entries +
                   [self.mouse_interval_entry, self.toggle_key_entry, self.panic_key_entry,
                    self.test_key_entry, self.rebind_button, self.select_region_button,
    ...
    # Funkcja F10 – wykonanie nowego screenshotu i aktualizacja okna
    ...
    def rebind_hotkeys(self):
        ...
        # Klawisz F10 dla nowego screenshotu – stały
        keyboard.add_hotkey("F10", self.new_screenshot)
        self.log_message(f"Hotkeys ustawione: Toggle = {toggle_key}, Panic = {panic_key}, Ustal wzorzec = {test_key}, Nowy Screenshot = F10")
