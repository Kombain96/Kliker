...
class AutoClicker:
    def __init__(self, root):
        ...
        # Ramka wyboru regionu (interaktywnie) oraz testowy zrzut ekranu
        ...
        # Przycisk do wykonania testowego zrzutu ekranu
        self.test_button = ttk.Button(frame_region, text="Testowy zrzut", command=self.test_screenshot)
    ...
    def lock_interface(self):
        widgets = (self.key_entries + self.interval_entries +
                   [self.mouse_interval_entry, self.toggle_key_entry, self.panic_key_entry,
                    self.rebind_button, self.min_contour_entry, self.shape_option,
                    self.red_min_entry, self.green_max_entry, self.blue_max_entry,
                    self.select_region_button, self.test_button, self.save_config_button, self.load_config_button])
    ...
    def test_screenshot(self):
        ...
        # Powiąż zdarzenia myszy do zaznaczania obiektu
    ...
    def test_mouse_up(self, event):
        ...
        # Dodatkowa logika przetwarzania zaznaczonego obszaru może być dodana tutaj
