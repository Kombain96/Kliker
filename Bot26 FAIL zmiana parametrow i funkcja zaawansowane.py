...
class AutoClicker:
    def __init__(self, root):
        ...
        # Pole do ustawiania klawisza dla nowego screenshotu (wcześniej F10)
    ...
    # -------------------- Zaawansowane wyszukiwanie obrazu z ORB, FLANN, RANSAC, wieloskalowością --------------------
    def advanced_image_search(self, screenshot, template):
        ...
        best_dst = None
        # Wieloskalowe przeszukiwanie – iteracja po skalach
        ...
        for scale in scales:
            try:
                ...
                continue
            # Tworzymy detektor ORB z ustawieniami z GUI
