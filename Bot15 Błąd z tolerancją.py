...
class AutoClicker:
    def __init__(self, root):
        ...
        # Pozostawione – mogą być użyteczne przy innych ustawieniach
    ...
    def test_mouse_up(self, event):
        ...
        # Zamiast ustalania tolerancji koloru, ustawiamy wybrany obszar jako wzorzec do wyszukiwania
    ...
    def advanced_image_search(self, screenshot, template):
        # Konwersja obrazów do skali szarości (obrazy w formacie RGB)
        ...
        while True:
            if self.tracking_enabled:
                try:
                    ...
                    # Jeśli wzorzec został ustawiony, wykorzystaj zaawansowane wyszukiwanie obrazu
